...
public class ExcelUtil {
    ...
    public static <T> List<T> importExcel(MultipartFile file, Class<T> pojoClass) throws IOException {
        return importExcel(file, Constant.TITLE_ROWS_DEFAULT, Constant.TITLE_ROWS_DEFAULT, pojoClass);
    }
     ...
     * @param needVerify  是否检验excel内容
     * @param pojoClass  pojo类型
     * @param handler  自定义检验规则
     * @param <T>
     * @return
     * @throws IOException
     */
        public static <T> ExcelImportResult<T> importExcel(InputStream inputStream, Integer titleRows, Integer headerRows, boolean needVerify, Class<T> pojoClass, IExcelVerifyHandler handler) throws IOException {
            if (inputStream == null) {
                return null;
            }
            ImportParams params = new ImportParams();
